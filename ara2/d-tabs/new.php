  ...
  <div class="row">
    ...
    <div class="card p-3 col-md-9" style="width: 100%">
      ...
      if(isset($_POST['submitme'])){
        ...
        $featured_image = mysqli_real_escape_string($conn, $_POST['new-featured-image']);
        $sql = "INSERT INTO posts(title,author,content,featured_image) VALUES ('$title', '$author', '$content', '$featured_image')";
    ...
    <div class="col-md-3">
      <div class="card p-3 col-md-10" style="width: 100%">
        featured image:
        <input type="text"><input type="submit" value="ok" name="new-featured-image">
      </div>
    </div>
  </div>
</form>
